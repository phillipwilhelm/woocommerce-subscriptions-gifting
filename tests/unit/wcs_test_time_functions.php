...
class WCS_Time_Functions_Unit_Tests extends WCS_Unit_Test_Case {
	...
	public function test_wcs_get_subscription_ranges() {
		...
		$expected_output_months = array(
			 0 => 'all time',  1 => '1 month',  2 => '2 months',    3 => '3 months',
		...
		$expected_output_weeks = array(
			 0 => 'all time',  1 => '1 week',    2 => '2 weeks',   3 => '3 weeks',
		...
		$expected_output_days = array(
			 0 => 'all time', 1 => '1 day',    2 => '2 days',   3 => '3 days',
	 ...
	 * @since 2.0
	 */
	public function test_wcs_add_time( $from, $expected, $interval, $period ) {
		$actual_result = wcs_add_time( $interval, $period, strtotime( $from ) );
	 ...
	 * @since 2.0
	 */
	public function test_wcs_add_months( $from_date, $expected, $months_to_add ) {
		$actual_result = wcs_add_months( strtotime( $from_date ), $months_to_add );
